        ...
        <main>
            <div class="principal">
                ...
                <div class="container">
                    ...
                    <div class="func">
                        <a href="../Cadastro de usuário/Secretaria/index.php"><div class="func-box first">
                            <img src="../Imagens/article-white-18dp.svg" height="75px">
                            <h2>Cadastrar usuário</h2>
                        </div></a>

                        <a href="../Edição de usuário/Secretaria/Usuarios Cadastrados/UsuariosCadastrados.php"><div class="func-box last">
                            <img src="../Imagens/article-white-18dp.svg" height="75px">
