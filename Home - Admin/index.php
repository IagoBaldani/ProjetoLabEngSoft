...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="style-h-admin.css"/>
        ...
        <main>
            <div class="principal">
                ...
                <div class="container">
                    ...
                    <div class="func">
                        <a href="../Cadastro de usuário/Admin/index.php"><div class="func-box">
                            <img src="../Imagens/article-white-18dp.svg" height="75px">
                            <h2>Cadastrar usuário</h2>
                        </div></a>
                        <a href="../Edição de usuário/Admin/Usuarios Cadastrados/UsuariosCadastrados.php"><div class="func-box">
                            <img src="../Imagens/article-white-18dp.svg" height="75px">
