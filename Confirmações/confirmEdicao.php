        ...
        <main>
            <div class="container">
                ...
                <div class="submit-box">
                    ...
                    <a class="a2" href="<?php if($dado['tipo']==1){echo '../Edição de usuário/Admin/edicaoUsuarioAdmin.php?id=';echo $id_usuario;echo'&usuario=';echo $codigo_usuario;}else{echo '../Edição de usuário/Secretaria/edicaoUsuarioSecretaria.php?id=';echo $id_usuario;echo'&usuario=';echo $codigo_usuario;} ?>" >Cancelar</a>
                </div>
            </div>
        </main>
    </body>
