        ...
        <main>
            <div class="container">
                ...
                <div class="submit-box">
                         ...
                         <a class="a2" href="<?php if($dado['tipo']==1){echo '../CadastroArtigo/cadastroArtigo.php?id=';echo $id_usuario;}else{echo '../CadastroArtigo/cadastroArtigo.php?id=';echo $id_usuario;} ?>" >Cancelar</a>
